context("Searching", () => {
  ...
  describe("search results should be ranked by modified levenshtein distance", () => {
    it("should show nipîhk before nipiy if the search string is the former", () => {
      cy.visit("http://10.2.10.152/search/?q=nipiy");
      cy.contains("nipiy");
      cy.contains("💧");
      cy.contains("water");
    });
  ...
  //     cy.visit("http://10.2.10.152/search/?q=nîpîhk");
  //     cy.contains("nipiy");
  //     cy.contains("💧");
  //     cy.contains("water");
  //   });
