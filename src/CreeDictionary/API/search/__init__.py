...
def search_with_affixes(query: str, include_auto_definitions=False, inflect_english_phrases=False):
    """
    ...
    return search(query=query, include_auto_definitions=include_auto_definitions, inflect_english_phrases=inflect_english_phrases)


def simple_search(query: str, include_auto_definitions=False, inflect_english_phrases=False):
    """
