...
def does_lc_match_xml_entry(
    ...
    >>> does_lc_match_xml_entry(WordClass.VTI, 'V', '')
    True
    >>> does_lc_match_xml_entry(WordClass.VTI, 'V', 'VTI-?')
    True
    >>> does_lc_match_xml_entry(WordClass.VTI, '', '')
    False
    >>> does_lc_match_xml_entry(WordClass.VTI, 'V', 'VAI-2')
    False
    >>> does_lc_match_xml_entry(WordClass.VTI, 'N', '')
    False
    >>> does_lc_match_xml_entry(WordClass.VTI, 'V', 'IJFIJFIJSAJDIAIDJRN')
    True
    """
    ...
    if (
        ...
        or (xml_pos == "Ipc" and lc is WordClass.IPC)
        or (xml_pos == "Pron" and lc is WordClass.Pron)
    ):
