    ...
    def fetch_lemma_by_user_query(user_query: str) -> CreeAndEnglish:
        ...
        for analysis in fst_analyses:
            ...
            if exact_matched_lemmas.exists():
                ...
                # todo: move pronoun searching here

        # todo: exhaustively search preverbs here (since we can't use fst)
        ...
        # preverbs and pronouns should be presented
        ...
        # for pronouns pos="PRON" is enough

        for preverb_or_pronoun in Wordform.objects.filter(
            Q(full_lc="IPV") | Q(pos="IPV") | Q(pos="PRON"),
            ...
            lemmas_by_analysis[preverb_or_pronoun.analysis].append(preverb_or_pronoun)
